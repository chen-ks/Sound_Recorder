...
import static com.example.sound_recorder.MainActivity.tp;
...
public class Dialog extends AppCompatActivity {
    ...
    private android.app.Dialog mDialog, mDialogAudio;
    ...
    public boolean showDeleteDialog(final String getdata, final String getAddress){
        ...
        StrictMode.setVmPolicy(builder.build());
        builder.detectFileUriExposure();
        mDialog=new android.app.Dialog(mDialogContext, R.style.Theme_AudioDialog);
        ...
        mDialogLoadBtn=(Button)mDialog.findViewById(R.id.DialogLoad_Ok);
        mDialogOkBtn.setTypeface(tp);
        mDialogCancelBtn.setTypeface(tp);
        mDialogShareBtn.setTypeface(tp);
        mDialogLoadBtn.setTypeface(tp);
        ...
        mDialogShareBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
       //         saveToDrive(getCtx(),GetAddress);
                shareFileDialog(getCtx(),GetAddress);
            }
        });
        mDialogLoadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                saveToDrive(getCtx(),GetAddress);
            }
    ...
    public void showPlayDialog(final String getName){
        mDialogAudio =new android.app.Dialog(mDialogContext, R.style.Theme_AudioDialog);
        LayoutInflater inflater=LayoutInflater.from(mDialogContext);
        ...
        mDialogPlayCancelBtn=(Button)mDialogAudio.findViewById(R.id.Dialog_cancel);
        mDialogPlayBtn.setTypeface(tp);
        mDialogPauseBtn.setTypeface(tp);
        mDialogPlayCancelBtn.setTypeface(tp);
        ...
        mDialogPlayCancelBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mDialogAudio.dismiss();
            }
    ...
    public void shareFileDialog(Context context,String mAddress) {
        ...
        Log.d("url",Uri.fromFile(new File(mAddress))+"");
        shareIntent.setType("audio/mp3");
        context.startActivity(Intent.createChooser(shareIntent, "发送"));
    }
